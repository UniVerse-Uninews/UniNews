  ...
  return (
    <>
      ...
      <ContainerCabecalho style={styles.container}>
        ...
        >
          <Image
            source={currentRoute === "Feed" ? dirIconHouse : dirIconNotHouse}
            style={styles.icon}
          />
        </Pressable>
        <Pressable
        ...
        >
          <Image
            source={currentRoute === "Pesquisar" ? dirIconSearch : dirIconGlass}
            style={styles.icon}
          />
        </Pressable>
        <Pressable
        ...
        >
          <Image
            source={
              currentRoute === "LerNoticia" ? dirIconUnsaved : dirIconSaved
            }
            style={styles.icon}
          />
        </Pressable>
        ...
        >
          <Image
            source={
              currentRoute === "Perfil" ? dirIconProfileFull : dirIconProfile
            }
            style={styles.icon}
          />
        </Pressable>
