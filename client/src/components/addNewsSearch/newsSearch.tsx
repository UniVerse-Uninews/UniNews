...
const NewsCardSearch: React.FC<NewsCardProps> = ({ news, savedNewsIds, handleSaveNews, handleRemoveNews }) => {
              ...
              <View style={styles.iconContainer}>
                ...
                onPress={() => {
                  if (item.universityId) {
                    ...
                    Alert.alert('Erro', 'Informações da universidade não estão disponíveis.');
