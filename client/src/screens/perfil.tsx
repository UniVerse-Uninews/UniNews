...
export function Perfil() {
  ...
  const { setUser, updateUserHandler, userFields } = useCrud();
      ...
      <Container style={styles.container}>
        ...
        <ContainerData style={styles.containerData}>
          ...
          <View style={styles.box1}>
            ...
            >
              <View style={styles.centeredView}>
                <ContainerAlter style={styles.modalView}>
                  ...
                  >
                    <NameAlter style={styles.textStyle}>
                      REDEFINIR SENHA
                    </NameAlter>
                  </TouchableOpacity>
            ...
            >
              <Text style={styles.campotext1}>EDITAR </Text>
              <Text style={styles.campotext1}>DADOS</Text>
            </TouchableOpacity>
          </View>
        </ContainerData>
      ...
      >
        <View style={styles.centeredView}>
          <ContainerAlter style={styles.modalView}>
            ...
            <View style={styles.containerInput}>
              <NameAlter style={styles.modalText}>
