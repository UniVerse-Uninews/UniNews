...
} from "./controllers/university/get-all-university";
...
} from "./controllers/news/temp-npm";
...
import {
  ...
  checkIfUserFollowsUniversity,
} from "./controllers/save/save";
import {
...
import {
  getStatesByCountryHandler,
  getUniversitiesByStateHandler,
} from "./controllers/university/get-university-name-location";
...
export async function appRoutes(app: FastifyInstance) {
  ...
  app.get(
    "/getallusers",
    { preValidation: [app.verifyJwt, verifyUserRole("ADMIN")] },
  ...
  app.get(
    "/user/:userId/university/:universityId/follow-status",
    checkIfUserFollowsUniversity
  );
  app.get(
    "/user/:userId/followed-universities",
    getFollowedUniversitiesHandler
  );
}
